 ...
 const {setShowSearch} = useContext(ShopContext)
    ...
    return (
        <div className='flex items-center justify-between py-5 font-medium'>
            ...
            <div className="flex items-center gap-6">
                ...
                <div className="group relative">
                    ...
                    <div className="group-hover:block hidden absolute drop-shadow-menu right-0 pt-4">
                        ...
                        <div className="flex flex-col gap-2 w-36 py-3 bg-slate-100 text-black-300 p-4">
            ...
            {/**** side bar menu for small screen ok ****/}

            <div className={`absolute top-0 right-0 bottom-0 overflow-hidden bg-white transition-all ${visible ?  'w-full' : 'w-0'}`}>
                <div className="flex flex-col items-end gap-5 p-5">
                    <img onClick={() => setVisible(false)} src={assets.close_icon} className='w-5 cursor-pointer' alt="" />
